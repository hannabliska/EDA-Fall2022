...
* text size #default size eleven
* axis label colors #default gray
...
theme_set(mytheme) #Hanna question: does this go through the whole R chunk?
...
scales::show_col(colormap(colormap = colormaps$viridis, nshades = 16)) #blues
scales::show_col(colormap(colormap = colormaps$inferno, nshades = 16)) #oranges
scales::show_col(colormap(colormap = colormaps$magma, nshades = 16)) #purple
display.brewer.all(n = 9) #displaying just 9 
...
library(cowplot) #allows you to plot two different plot objects that you have made
