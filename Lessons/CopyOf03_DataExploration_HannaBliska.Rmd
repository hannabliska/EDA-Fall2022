...
> Answer: It shows the dependent pacakges, and lets you know when your installation was successful.
...
> ANSWER: You can find the file in the metadata. This helps us understand how we could download the data ourselves or how someone else could if we were to share it with them. It also notes all of the columns, so that we could check to make sure the data was correctly downloaded (and the dates of the data as well.)
...
> Answer: Blank cells were represented by NA.
...
> Answer: Time series never remove NAs, uses other methods to replace NAs. But for other types of analysis, we want to omit the NAs and work with what we have.
