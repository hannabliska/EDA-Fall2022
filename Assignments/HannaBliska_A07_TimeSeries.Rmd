...
> Answer: The results of my trend analysis for monthly Ozone concentrations indicates that there is a trend in the seasonal data (p=0.04). From the plot in #13, we can see that monthly ozone concentrations have a slightly decreasing trend over time. This decreasing trend is confirmed by the negative s statistic produced by the seasonal Mann-Kendall test (s=-77). In the plot from #13, the decreasing trend is particularly visible when comparing mean monthly ozone concentrations in the summer seasons over time; we can see that in 2010 and 2011, the mean monthly ozone concentrations in the summer months were higher than those in the summer months of 2017-2019. The results of our analysis allows us to reject the null hypothesis that the data are stationary and accept the alternative hypothesis that there is a decreasing trend in the data.
