...
scrape.it <- function(the_PWSID, the_year){
  ...
  webpage <- read_html(paste0(
    "https://www.ncwater.org/WUDC/app/LWSP/report.php?",the_PWSID, "&", the_year))
  ...
  #data frame
  scrape_max_withdrawals_df <- max_withdrawals_df %>%
  mutate("Year" = !!the_year, 
         "PSWID" =!!the_PWSID)
         
}
max_withdrawals_df <- scrape.it("03-32-010", 2021)
...
max_withdrawals_df <- scrape.it('03-32-010', 2015)
view(max_withdrawals_df)
