...
#used mutate to modify column AQS_PARAMETER_DESC to have PM2.5 in each row in the two PM2.5 data frames.
...
#11
write.csv(EPAair_03_PM25_NC1819_Processed_Spread, row.names=FALSE, file="./Data/Processed/EPAair_O3_PM25_NC1819_Processed.csv") #saved processed file
