...
#changing from factor to date and formatting
...
```{r}
#7
EPAair_O3_NC1819_Processed <- full_join(AQI.EPAair.O3.2018, AQI.EPAair.O3.2019)
#joining O3 datasets
EPAair_PM25_NC1819_Processed <-full_join(AQI.EPAair.PM25.2018, AQI.EPAair.PM25.2019)
#joining PM2.5 datasets
EPAair_03_PM25_NC1819_Join <- full_join(EPAair_O3_NC1819_Processed,EPAair_PM25_NC1819_Processed)
#joining O3 and PM2.5 datasets
...
#spreading AQI values into two columns
