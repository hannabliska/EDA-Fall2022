...
> Answer: This figure suggests that temperature decreases in response to increases in depth. This is an intuitive result, as the load of light energy (which heats water) is high at shallow depths but decreases as light travels through water to deeper depths. The distribution of points suggests that the relationship between depth and temperature is a decreasing (negative) linear trend; however, there is some variation in the distribution of the temperature data, particularly in the shallower depths, and there are also fewer measurements of temperature recorded at deeper depths. 
The variation in the distribution of the data visually suggests in terms of linearity of the trend that depth and temperature may not have a very strong linear relationship and thus that depth may not explain all of the variation in temperature. However, it is difficult to discern the strength of the linear trend visually; we can test its strength through performing a linear regression. The distribution of the data also suggests that depth and temperature may have a non-linear relationship, as the data form a non-linear distribution.
